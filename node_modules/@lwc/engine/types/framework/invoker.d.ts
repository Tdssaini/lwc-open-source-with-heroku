...
export declare let vmBeingConstructed: UninitializedVM | null;
...
export declare function invokeComponentConstructor(vm: UninitializedVM, Ctor: ComponentConstructor): void;

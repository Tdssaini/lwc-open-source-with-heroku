var LWC = (function (exports) {
    ...
    ***************************************************************************** */
     ...
     * For full license text, see the LICENSE file in the repo root or https://opensource.org/licenses/MIT
     */
    var assign = Object.assign, create = Object.create, defineProperties = Object.defineProperties, defineProperty = Object.defineProperty, freeze = Object.freeze, getOwnPropertyDescriptor = Object.getOwnPropertyDescriptor, getOwnPropertyNames = Object.getOwnPropertyNames, getPrototypeOf = Object.getPrototypeOf, hasOwnProperty = Object.hasOwnProperty, keys = Object.keys, seal = Object.seal, setPrototypeOf = Object.setPrototypeOf;
    var isArray$1 = Array.isArray;
    var _c = Array.prototype, forEach = _c.forEach, ArrayIndexOf = _c.indexOf, ArrayJoin = _c.join, ArrayMap = _c.map, ArrayPush = _c.push, ArrayReduce = _c.reduce, ArraySlice$1 = _c.slice, ArrayUnshift$1 = _c.unshift;
    var _d = String.prototype, StringCharCodeAt = _d.charCodeAt, StringReplace = _d.replace, StringSlice = _d.slice, StringToLowerCase = _d.toLowerCase;
     ...
     * For full license text, see the LICENSE file in the repo root or https://opensource.org/licenses/MIT
     */
    var _e = Element.prototype, hasAttribute = _e.hasAttribute, getAttribute = _e.getAttribute, setAttribute = _e.setAttribute, setAttributeNS = _e.setAttributeNS, removeAttribute = _e.removeAttribute, removeAttributeNS = _e.removeAttributeNS;
    ...
    var _f = String.prototype, StringReplace$1 = _f.replace, StringToLowerCase$1 = _f.toLowerCase;
    ...
    var EmptyArray = seal([]);
    var ViewModelReflection = createFieldName$1('ViewModel', 'engine');
    ...
    function getFormattedComponentStack(elm) {
        ...
        var indentationChar = '\t';
        var indentation = '';
        var currentNode = elm; // traversing up via getRootNode logic to find the component stack
        do {
            ...
            var newRootNode = currentNode.getRootNode();
    ...
    var _g = Array.prototype, ArrayPush$1 = _g.push, ArrayConcat = _g.concat;
    var OtS$1 = {}.toString;
    ...
    var _h = Array.prototype, ArraySplice$1 = _h.splice, ArrayIndexOf$1 = _h.indexOf, ArrayPush$2 = _h.push;
        ...
        ReactiveObserver.prototype.reset = function () {
            ...
            if (len > 0) {
                for (var i_4 = 0; i_4 < len; i_4 += 1) {
                    ...
                    var pos = ArrayIndexOf$1.call(listeners[i_4], this);
    ...
    function HTMLBridgeElementFactory(SuperClass, props, methods) {
        ...
        for (var i_5 = 0, len = props.length; i_5 < len; i_5 += 1) {
            var propName = props[i_5];
        ...
        for (var i_6 = 0, len = methods.length; i_6 < len; i_6 += 1) {
            var methodName = methods[i_6];
     ...
     * For full license text, see the LICENSE file in the repo root or https://opensource.org/licenses/MIT
     */
    var getHiddenField$1 = fields.getHiddenField;
    ...
    function update(oldVnode, vnode) {
        ...
        var elm = vnode.elm;
        var vm = getHiddenField$1(elm, ViewModelReflection);
     ...
     * For full license text, see the LICENSE file in the repo root or https://opensource.org/licenses/MIT
     */
    var getHiddenField$2 = fields.getHiddenField;
    function createContext(vnode) {
        ...
        var elm = vnode.elm;
        var vm = getHiddenField$2(elm, ViewModelReflection);
        if (!isUndefined(vm)) {
    ...
    */
    ...
    function updateStaticChildren(parentElm, oldCh, newCh) {
        ...
        for (var i_7 = length - 1; i_7 >= 0; i_7 -= 1) {
            var vnode = newCh[i_7];
            var oldVNode = oldCh[i_7];
            if (vnode !== oldVNode) {
                if (isVNode(oldVNode)) {
                    if (isVNode(vnode)) {
        ...
        assign(descriptors, {
            ...
            addEventListener: generateDataDescriptor({
                value: function (type, listener, options) {
                    assert.invariant(!isRendering, vmBeingRendered + ".render() method has side effects on the state of " + toString(sr) + " by adding an event listener for \"" + type + "\"."); // TODO: #420 - this is triggered when the component author attempts to add a listener
    ...
    function getCustomElementRestrictionsDescriptors(elm, options) {
        ...
        return assign(descriptors, {
            ...
            addEventListener: generateDataDescriptor({
                value: function (type, listener, options) {
                    assert.invariant(!isRendering, vmBeingRendered + ".render() method has side effects on the state of " + toString(this) + " by adding an event listener for \"" + type + "\"."); // TODO: #420 - this is triggered when the component author attempts to add a listener
    ...
    function register(service) {
        ...
        for (var i_8 = 0; i_8 < hooks.length; ++i_8) {
            var hookName = hooks[i_8];
    ...
    function invokeServiceHook(vm, cbs) {
        ...
        for (var i_9 = 0, len = cbs.length; i_9 < len; ++i_9) {
            cbs[i_9].call(undefined, component, data, def, context);
        }
    }
    /*
     * Copyright (c) 2018, salesforce.com, inc.
    ...
    var ElementHook = {
        create: function (vnode) {
            ...
            var ns = data.ns; // TODO: issue #1364 - supporting the ability to inject a cloned StyleElement
    ...
    function evaluateTemplate(vm, html) {
        ...
        var component = vm.component, context = vm.context, cmpSlots = vm.cmpSlots, cmpTemplate = vm.cmpTemplate; // reset the cache memoizer for template when needed
        if (html !== cmpTemplate) {
     ...
     * For full license text, see the LICENSE file in the repo root or https://opensource.org/licenses/MIT
     */
    var ShadowRootHostGetter = getOwnPropertyDescriptor(ShadowRoot.prototype, 'host').get;
    ...
    var setHiddenField$1 = fields.setHiddenField;
    /**
    ...
    BaseLightningElementConstructor.prototype = {
        ...
        get classList() {
            if (process.env.NODE_ENV !== 'production') {
                var vm = getComponentVM(this); // TODO: #1290 - this still fails in dev but works in production, eventually, we should just throw in all modes
     ...
     * For full license text, see the LICENSE file in the repo root or https://opensource.org/licenses/MIT
     */
    var runtimeFlags = create$2(null); // This function is not whitelisted for use within components and is meant for
    // configuring runtime feature flags during app initialization.
    function setFeatureFlag(name, value) {
        var isBoolean = isTrue$1$1(value) || isFalse$1$1(value);
        if (!isBoolean) {
            var message = "Invalid " + typeof value + " value specified for the \"" + name + "\" flag. Runtime feature flags can only be set to a boolean value.";
            if (process.env.NODE_ENV === 'production') {
    ...
    var getHiddenField$4 = fields.getHiddenField;
    ...
    function getComponentConstructor(elm) {
        ...
        if (elm instanceof HTMLElement) {
            var vm = getHiddenField$4(elm, ViewModelReflection);
            if (!isUndefined(vm)) {
                ctor = vm.def.ctor;
            }
        }
    ...
    var getHiddenField$5 = fields.getHiddenField;
    ...
    function getErrorComponentStack(startingElement) {
        ...
        var elm = startingElement;
        do {
            var currentVm = getHiddenField$5(elm, ViewModelReflection);
    ...
    function getParentOrHostElement(elm) {
        var parentElement = parentElementGetter.call(elm); // If parentElement is a shadow root, find the host instead
    ...
    function getCustomElementVM(elm) {
        if (process.env.NODE_ENV !== 'production') {
            var vm = getHiddenField$5(elm, ViewModelReflection);
            assert.isTrue(vm && 'cmpRoot' in vm, vm + " is not a vm.");
        }
    ...
    function getComponentVM(component) {
        if (process.env.NODE_ENV !== 'production') {
            var vm = getHiddenField$5(component, ViewModelReflection);
            assert.isTrue(vm && 'cmpRoot' in vm, vm + " is not a vm.");
        }
    ...
    function getShadowRootVM(root) {
        ...
        if (process.env.NODE_ENV !== 'production') {
            var vm = getHiddenField$5(root, ViewModelReflection);
            assert.isTrue(vm && 'cmpRoot' in vm, vm + " is not a vm.");
        }
    ...
    function runWithBoundaryProtection(vm, owner, pre, job, post) {
        ...
        try {
            ...
            if (!isUndefined(error)) {
                ...
                var errorBoundaryVm = isNull(owner) ? undefined : getErrorBoundaryVMFromOwnElement(owner);
     ...
     * For full license text, see the LICENSE file in the repo root or https://opensource.org/licenses/MIT
     */
    var createFieldName$2 = fields.createFieldName, getHiddenField$6 = fields.getHiddenField, setHiddenField$2 = fields.setHiddenField;
    var ConnectingSlot = createFieldName$2('connecting', 'engine');
    var DisconnectingSlot = createFieldName$2('disconnecting', 'engine');
    ...
    function createElement(sel, options) {
        ...
        setHiddenField$2(element, ConnectingSlot, function () {
        ...
        setHiddenField$2(element, DisconnectingSlot, function () {
            var vm = getCustomElementVM(element);
            removeRootVM(vm);
        });
        return element;

(function (factory) {
  ...
  var _c = Array.prototype, ArrayConstructor = _c.constructor, ArrayFilter = _c.filter, ArrayFind = _c.find, forEach = _c.forEach, ArrayIndexOf = _c.indexOf, ArrayJoin = _c.join, ArrayMap = _c.map, ArrayPush = _c.push, ArrayReduce = _c.reduce, ArrayReverse = _c.reverse, ArraySlice = _c.slice, ArraySplice = _c.splice, ArrayUnshift = _c.unshift;
  ...
  var DOCUMENT_POSITION_CONTAINED_BY = Node.DOCUMENT_POSITION_CONTAINED_BY, DOCUMENT_POSITION_CONTAINS = Node.DOCUMENT_POSITION_CONTAINS, DOCUMENT_POSITION_PRECEDING = Node.DOCUMENT_POSITION_PRECEDING, DOCUMENT_POSITION_FOLLOWING = Node.DOCUMENT_POSITION_FOLLOWING, ELEMENT_NODE = Node.ELEMENT_NODE, TEXT_NODE = Node.TEXT_NODE, CDATA_SECTION_NODE = Node.CDATA_SECTION_NODE, PROCESSING_INSTRUCTION_NODE = Node.PROCESSING_INSTRUCTION_NODE, COMMENT_NODE = Node.COMMENT_NODE, DOCUMENT_FRAGMENT_NODE = Node.DOCUMENT_FRAGMENT_NODE;
  var _e = Node.prototype, appendChild = _e.appendChild, cloneNode = _e.cloneNode, compareDocumentPosition = _e.compareDocumentPosition, insertBefore = _e.insertBefore, removeChild = _e.removeChild, replaceChild = _e.replaceChild, hasChildNodes = _e.hasChildNodes, contains = _e.contains;
  ...
  var _f = Element.prototype, hasAttribute = _f.hasAttribute, getAttribute = _f.getAttribute, setAttribute = _f.setAttribute, removeAttribute = _f.removeAttribute, querySelectorAll = _f.querySelectorAll, getBoundingClientRect = _f.getBoundingClientRect, getElementsByTagName = _f.getElementsByTagName, getElementsByTagNameNS = _f.getElementsByTagNameNS;
  var _g = Element.prototype, addEventListener = _g.addEventListener, removeEventListener = _g.removeEventListener;
  ...
  var _h = Document.prototype, createComment = _h.createComment, querySelectorAll$1 = _h.querySelectorAll, getElementById = _h.getElementById, getElementsByClassName$1 = _h.getElementsByClassName, getElementsByTagName$1 = _h.getElementsByTagName, getElementsByTagNameNS$1 = _h.getElementsByTagNameNS;
  ...
  var runtimeFlags = create$1(null);
  ...
  var createFieldName$1 = fields.createFieldName, getHiddenField$1 = fields.getHiddenField, setHiddenField$1 = fields.setHiddenField;
  ...
  StaticNodeList.prototype = create(NodeList.prototype, (_a = {
          ...
          entries: {
              ...
              configurable: true,
              value: function () {
                  return ArrayMap.call(getHiddenField$1(this, Items), function (v, i) { return [i, v]; });
              }
          },
          keys: {
              writable: true,
              ...
              configurable: true,
              value: function () {
                  return ArrayMap.call(getHiddenField$1(this, Items), function (v, i) { return i; });
              }
          },
          values: {
              writable: true,
  ...
  var createFieldName$2 = fields.createFieldName, getHiddenField$2 = fields.getHiddenField, setHiddenField$2 = fields.setHiddenField;
  ...
  StaticHTMLCollection.prototype = create(HTMLCollection.prototype, (_b = {
          ...
          entries: {
              ...
              configurable: true,
              value: function () {
                  return ArrayMap.call(getHiddenField$2(this, Items$1), function (v, i) { return [i, v]; });
              }
          },
          keys: {
              writable: true,
              ...
              configurable: true,
              value: function () {
                  return ArrayMap.call(getHiddenField$2(this, Items$1), function (v, i) { return i; });
              }
          },
          values: {
              writable: true,
      ...
      _b[Symbol.iterator] = {
          ...
          value: function () {
              ...
              return {
                  next: function () {
                      var items = getHiddenField$2(_this, Items$1);
                      return nextIndex < items.length ? {
                          value: items[nextIndex++],
                          done: false
                      } : {
  ...
  var getHiddenField$3 = fields.getHiddenField, setHiddenField$3 = fields.setHiddenField, createFieldName$3 = fields.createFieldName;
  ...
  function getInitializedFeatureFlags() {
      ...
      return {
          DISABLE_NODE_PATCH: DISABLE_NODE_PATCH
      };
  }
  ...
  var _k = OriginalMutationObserver.prototype, originalDisconnect = _k.disconnect, originalObserve = _k.observe, originalTakeRecords = _k.takeRecords;
  ...
  var observer;
  var createFieldName$4 = fields.createFieldName, getHiddenField$4 = fields.getHiddenField, setHiddenField$4 = fields.setHiddenField;
  var observerConfig = {
      childList: true
  };
  ...
  function getNonPatchedFilteredArrayOfNodes(context, unfilteredNodes) {
      ...
      if (!isUndefined(ownerKey)) {
          if (isHostElement(context)) {
              ...
              filtered = ArrayFilter.call(unfilteredNodes, function (elm) { return getNodeOwnerKey(elm) === ownerKey; });
          }
      }
  ...
  var _l = getInitializedFeatureFlags$1(), DISABLE_ELEMENT_PATCH = _l.DISABLE_ELEMENT_PATCH, ENABLE_NODE_LIST_PATCH = _l.ENABLE_NODE_LIST_PATCH;
  ...
  function getInitializedFeatureFlags$1() {
      var DISABLE_ELEMENT_PATCH;
      var ENABLE_NODE_LIST_PATCH;
      ...
      return {
          DISABLE_ELEMENT_PATCH: DISABLE_ELEMENT_PATCH,
          ENABLE_NODE_LIST_PATCH: ENABLE_NODE_LIST_PATCH
      };
  }
  ...
  function querySelectorPatched() {
      ...
      if (isHostElement(this)) {
          ...
          if (!isUndefined(ownerKey_1) || ENABLE_NODE_LIST_PATCH) {
              var elm = ArrayFind.call(nodeList, function (elm) { return getNodeOwnerKey(elm) === ownerKey_1; });
  ...
  function getFilteredArrayOfNodes(context, unfilteredNodes, shadowDomSemantic) {
      ...
      if (isHostElement(context)) {
          ...
          if (!isUndefined(ownerKey_2) || shadowDomSemantic === ShadowDomSemantic.Enabled) {
              filtered = ArrayFilter.call(unfilteredNodes, function (elm) { return getNodeOwnerKey(elm) === ownerKey_2; });
          }
          else {
              filtered = ArraySlice.call(unfilteredNodes);
          }
  ...
  defineProperties(Element.prototype, {
      ...
      querySelectorAll: {
          value: function () {
              var nodeList = arrayFromCollection(querySelectorAll.apply(this, ArraySlice.call(arguments)));
              var shadowDomSemantic = ShadowDomSemantic.Disabled;
              if (runtimeFlags.ENABLE_NODE_LIST_PATCH) {
                  shadowDomSemantic = ShadowDomSemantic.Enabled;
              }
              var filteredResults = getFilteredArrayOfNodes(this, nodeList, shadowDomSemantic);
  ...
  var createFieldName$5 = fields.createFieldName, getHiddenField$5 = fields.getHiddenField, setHiddenField$5 = fields.setHiddenField;
  ...
  var _o = Node.prototype, dispatchEvent$1 = _o.dispatchEvent, superAddEventListener = _o.addEventListener, superRemoveEventListener = _o.removeEventListener;
